...
<acme:form readonly="${readonly}">
	...
	<acme:input-select code="administrator.announcement.form.label.critical" path="critical">
		<acme:input-option code="administrator.announcement.form.label.critical" value="true" selected="${critical}"/>
		<acme:input-option code="administrator.announcement.form.label.notcritical" value="false" selected="${!critical}"/>
	</acme:input-select>
	
	<acme:input-textarea code="administrator.announcement.form.label.body" path="body"/>
	
	<acme:input-url code="administrator.announcement.form.label.url" path="moreInfo"/>
