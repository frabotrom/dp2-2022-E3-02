...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.inventor.toolkits" access="hasRole('Inventor')">
			<acme:menu-suboption code="master.menu.inventor.toolkits.list" action="/inventor/toolkits/list"/>
		</acme:menu-option>
