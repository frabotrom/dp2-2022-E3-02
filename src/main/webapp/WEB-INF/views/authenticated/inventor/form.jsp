...
<acme:form>
	...
	<acme:input-textarea code="authenticated.inventor.form.label.statement" path="statement"/>
	<acme:input-url code="authenticated.inventor.form.label.info" path="info"/>
